...
function placeOrder() {
    ...
    // create the output
    var theOutput = "<p>Thank you for your order "+userName+"!</p>";
    var theOutput2 = "<p>Thank you for your order valued customer!</p>";
    ...
    if (userName.length < 1) {
        document.getElementById("displayTotal").innerHTML = theOutput2;
    }
    else{
